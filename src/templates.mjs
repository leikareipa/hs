...
export const templates = {
    "index.html": function({products, description, nonces}) {
        ...
        return readFileSync("./src/templates/html/index.html", "utf8")
            .replaceAll(
                "{{ PRODUCT_CARDS }}",
                combinedCards
            )
    ...
    "script.js": function() {
        return readFileSync("./src/templates/scripts/script.js", "utf8");
    },
    "index.css": function() {
    ...
    "graph.html": function({product}) {
        ...
        return readFileSync("./src/templates/html/graph.html", "utf8")
            .replaceAll(
                "{{ GRAPH_VIEWBOX }}",
                `0 -5 100 110`
            )
    ...
    "product-card-placeholder.html": function({product} = {}) {
        return readFileSync("./src/templates/html/product-card-placeholder.html", "utf8")
            .replaceAll(
                "{{ PRODUCT_NAME }}",
                product.name
            )
    ...
    "product-card.html": function({product}) {
        ...
        return readFileSync("./src/templates/html/product-card.html", "utf8")
            .replaceAll(
                "{{ PRODUCT_NAME }}",
                product.name
            )
